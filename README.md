...
Here’s a real-world example I use for my own homelab (fiber primary + Starlink failover, OPNsense, Proxmox, the usual suspects). Generated by Claude referencing `drawio-instructions.md` and opened in VS Code with Henning Dieterichs' unofficial VS Code extension without a single tantrum.

<a href="homelab-network-diagram.png" target="_blank">
  <img src="homelab-network-diagram.png" alt="My homelab network – finally legible" width="800">
</a>
