...
Here’s a real-world example I use for my own homelab (fiber primary + Starlink failover, OPNsense, Proxmox, the usual suspects).  
Generated by Claude referncing drawio-ninja → opened in VS Code with the unofficial drawio extensio without a single tantrum.
